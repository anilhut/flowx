...
const TypeFour: React.FC<CustomNodeProps> = (props) => {
  ...
  const { title, value1_header, value1_data, value2_header, value2_data, value3_header, value3_data, value4_header, value4_data, bgColorCondition, hasChildren, isCollapsed, onToggleCollapse } = props.data;

  return (
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      <div className={`${styles.nodeCustomContainer} ${styles.nodeTypeFour} ${getBgClass(styles, bgColorCondition)}`}>
